...
import {
  X, Plus, Award, TrendingUp, FileText, DollarSign, Calendar,
  ShoppingCart, Eye, Trash2, Edit, Save, Package, Settings
} from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 whitespace-pre-line">{customerData?.billing_address}</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-md font-semibold text-gray-900">Invoice Items</h3>
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded-md text-sm flex items-center space-x-2"
                  >
                    <Plus className="w-4 h-4" />
                    <span>Charge</span>
                  </button>
                  <button
                    ...
                    className="bg-purple-600 hover:bg-purple-700 text-white px-3 py-2 rounded-md text-sm flex items-center space-x-2"
                  >
            ...
            {/* Notes */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Invoice Notes (Optional)</label>
              <textarea
